...
namespace YxLica.Tools.Pay.LLWYPay
{
	public class PartnerConfig
	{
		...
		// RSA银通公钥
        public static string YT_PUB_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCSS/DiwdCf/aZsxxcacDnooGph3d2JOj5GXWi+q3gznZauZjkNP8SKl3J2liP0O6rU/Y/29+IUe+GTMhMOFJuZm1htAtKiu5ekW0GlBMWxf4FPkYlQkPE0FtaoMP3gYfh+OwI+fIRrpW3ySn3mScnc6Z700nU/VYrRkfcSCbSnRwIDAQAB";//ConfigurationManager.AppSettings["yeepayPublicKey"];
		// RSA商户私钥
		...
		// MD5 KEY
        public static string MD5_KEY = "201408071000001543test_20140812";//ConfigurationManager.AppSettings["MD5_KEY"]; 

        // 商户编号,请变更为您的商户号
        public static string OID_PARTNER = "201408071000001543";  //ConfigurationManager.AppSettings["OID_PARTNER"]; 
    
		// 签名方式 RSA或MD5
		public static string            SIGN_TYPE="MD5"; //  ConfigurationManager.AppSettings["SIGN_TYPE"]; 	
