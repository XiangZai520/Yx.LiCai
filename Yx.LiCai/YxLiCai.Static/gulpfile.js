...
gulp.task('default', ['clean'], function(){
    gulp.start('htmlDev', 'cssDev', 'jsDev', 'imgDev', 'fonts', 'data');
...
gulp.task('css-p', function(){
    ...
    //gulp.src(['css/**/*.css','!css/m_base.css'])
    //    .pipe(concat('wap_yx.css'))
