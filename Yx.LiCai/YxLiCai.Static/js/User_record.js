...
define('User_record', ['jquery', 'gxdialog', 'fastclick', 'swipe', 'gxtabs'], function (require, exports, module) {
    ...
    $(".loadmore a").on("click", function () {
        ...
        $.ajax({
            type: "POST",
            url: "/UserAssets/GetData_User_record",
            data: { CurrentPage: CurrentPage, Prodtype: ProductType },
            async: false,
