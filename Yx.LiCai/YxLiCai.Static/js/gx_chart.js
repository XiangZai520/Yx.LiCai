...
define('gx_chart', ['jquery'], function (require, exports, module) {
    ...
    var $balance = $('.user-balance'),
        ...
        $freeze = $('.user-freeze'),
        DataValue = {
            balance: $balance.children('strong').text(),
            investing: $investing.children('strong').text(),
            freeze: $freeze.children('strong').text(),
            bNum: parseFloat($balance.data('num')),
            iNum: parseFloat($investing.data('num')),
            fNum: parseFloat($freeze.data('num'))
        };
    $("#doughnutChart").drawDoughnutChart([
        { title: DataValue.balance, value : DataValue.bNum, color: "#00b7ee" },
        { title: DataValue.investing, value: DataValue.iNum, color: "#fe7c88" },
        { title: DataValue.freeze, value: DataValue.fNum, color: "#ffc016" }
    ],{
        segmentStrokeColor: "#f0f0f0",
        baseColor: "RGBA(240, 240, 240, .6)",
        summaryTitle: "总资产(元)"
    });
