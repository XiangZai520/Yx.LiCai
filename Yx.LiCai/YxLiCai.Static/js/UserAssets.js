...
define('UserAssets', ['jquery', 'gxdialog', 'fastclick', 'swipe', 'gxtabs'], function (require, exports, module) {
    ...
    //$(".assets-to").on("click", function () {

    //    var orderinfoid = $(this).attr("id");
    //    orderinfoid = orderinfoid.replace("orderinfoid_", "");
    //    window.top.location = "/UserAssets/PointerIncome?orderinfoid=" + orderinfoid;
    //})
});


seajs.use('UserAssets');
