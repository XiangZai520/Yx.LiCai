...
define('caculate', ['jquery'], function (require, exports, module) {
    ...
    $(".income-account .ui-btn").bind("click", function () {
        ...
        var formated_profit = Math.floor(expectedProfit * 100) / 100;
        if (formated_profit.toString().indexOf('.') < 0) {
            formated_profit = formated_profit + ".00";
        }
   
        top.find(".account-income").html("<h2>预期收益:</h2><b>" + formated_profit + "</b>");
    });
