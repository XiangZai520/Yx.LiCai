...
define('yixiu', ['jquery', 'gxdialog', 'fastclick', 'swipe', 'gxtabs'], function (require, exports, module) {
    ...
    $('.J_gxtabs').gxTabs({
        ...
        afterChange: function (tabId) {
            ...
            if (tabId == "0") {
                totalJgxtab = tabId;
                //3个月
                $("#purchasedAmount").html($("#q3_MemberSum").val());
                $("#yiledBase").html($("#q3_YieldBase").val() + "<em>%</em>");
                if (et2 > nt) {
                    $(".product-btn").html("");
                    $(".product-btn").append('<div class="next-time">距下期开售时间：<span class="t_d"></span>天 <span class="t_h"></span>:<span class="t_m"></span>:<span class="t_s"></span></div><a class="ui-btn ui-btn-gray" href="javascript:;">已售罄</a>');
                }
                else {
                    $(".product-btn").html("");
                    $(".product-btn").append('<a class="ui-btn buy"  href="/Buy/Buy_Product?ptype=2" style="cursor:pointer">立即买入</a>');
                }
                ...
                totalJgxtab = tabId;
                //6个月产品
                $("#purchasedAmount").html($("#q6_MemberSum").val());
                ...
                if (et3 > nt) {
                    ...
                    $(".product-btn").html("");
                    $(".product-btn").append('<a class="ui-btn buy"  href="/Buy/Buy_Product?ptype=3" style="cursor:pointer">立即买入</a>');
                }
    ...
    function touchTabs() {
        ...
        function setTab(elem) {
            ...
            if (parseInt(elem.getAttribute('data-tab')) == 0) {
                totalTouchTab = 0;
                if (et1 > nt) {
                    $(".product-btn").html("");
                    $(".product-btn").append('<div class="next-time">距下期开售时间：<span class="t_d"></span>天 <span class="t_h"></span>:<span class="t_m"></span>:<span class="t_s"></span></div><a class="ui-btn ui-btn-gray" href="javascript:;">已售罄</a>');
                    ...
                    $(".product-btn").html("");
                    $(".product-btn").append('<a class="ui-btn buy"  href="/Buy/Buy_Product?ptype=1" style="cursor:pointer">立即买入</a>');
                }
            ...
            else if (parseInt(elem.getAttribute('data-tab')) == 1) {
                totalTouchTab = 1;
                if ($("#quarter3Touch").hasClass("active")) {
                    if (et2 > nt) {
                        $(".product-btn").html("");
                        $(".product-btn").append('<div class="next-time">距下期开售时间：<span class="t_d"></span>天 <span class="t_h"></span>:<span class="t_m"></span>:<span class="t_s"></span></div><a class="ui-btn ui-btn-gray" href="javascript:;">已售罄</a>');
                    }
            ...
            else if (parseInt(elem.getAttribute('data-tab')) == 2) {
                totalTouchTab = 2;
                if (et4 > nt) {
                    $(".product-btn").html("");
                    $(".product-btn").append('<div class="next-time">距下期开售时间：<span class="t_d"></span>天 <span class="t_h"></span>:<span class="t_m"></span>:<span class="t_s"></span></div><a class="ui-btn ui-btn-gray" href="javascript:;">已售罄</a>');
                    ...
                    $(".product-btn").html("");
                    $(".product-btn").append('<a class="ui-btn buy"  href="/Buy/Buy_Product?ptype=4" style="cursor:pointer">立即买入</a>');
                }
