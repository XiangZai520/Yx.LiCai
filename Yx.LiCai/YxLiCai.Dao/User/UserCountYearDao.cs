...
namespace YxLiCai.Dao.User
{
    ...
    public class UserCountYearDao
    {
        ...
        {
            decimal MyMoney = 0;
            string strSql = @"SELECT  amount_invest AS amount FROM user_count_year WHERE user_id=?Id LIMIT 0,1";
        ...
        {
            string strSql = @"UPDATE user_count_year SET principal_fz=principal_fz+?order_investment,
