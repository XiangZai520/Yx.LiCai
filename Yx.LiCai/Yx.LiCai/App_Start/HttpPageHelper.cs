        ...
        public static string GetRemoteNetURL(SystemSiteEnum site, string str)
        {
            ...
            switch (site)
            {
                case SystemSiteEnum.MallWeb:
                    return System.Configuration.ConfigurationManager.AppSettings["MobileUrl"] + str; 
                case SystemSiteEnum.StaticResourceMallWeb:
                    return System.Configuration.ConfigurationManager.AppSettings["StaticUrl"] + s;
